...
function generateResume(): void {
    ...
    const profilePic = document.getElementById("resumeProfilePic") as HTMLImageElement;
    ...
    (document.getElementById("resumePosition") as HTMLElement).textContent = position;
    (document.getElementById("resumeDuration") as HTMLElement).textContent = duration;
    (document.getElementById("resumeDescription") as HTMLElement).textContent = description;
    ...
    // Soft Skills
    const softSkillsList = document.getElementById('softSkillsList') as HTMLUListElement;
...
function addSoftSkills(): void {
    const softSkillsInput = document.getElementById('softSkills') as HTMLInputElement;
    const softSkillsList = document.getElementById('softSkillsList') as HTMLUListElement;
...
function editResume(): void {
    ...
    (document.getElementById("resume-section") as HTMLElement).style.display = "none";
}
